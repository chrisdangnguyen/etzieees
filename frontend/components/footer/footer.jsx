...
const footerBar = () => {
    ...
    return(
        <div className="footer-container">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="wt-fill-denim wt-width-full" 
                viewBox="0 0 1280 30" preserveAspectRatio="xMidYMid slice" aria-hidden="true" 
                focusable="false">
